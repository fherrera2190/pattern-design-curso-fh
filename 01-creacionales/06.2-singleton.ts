...
class DatabaseConnection {
  ...
  public connect(): void {
    ...
    if (this.connected) {
      console.log("%cYa estas conectado a la base de datos...", COLORS.red);
      return;
    }
    this.connected = true;
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      ...
      console.log("%cDesconectando de la base de datos...", COLORS.green);
      return;
    }
    console.log("%cNo hay una conexion activa...", COLORS.red);
  }
}
